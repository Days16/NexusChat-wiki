...
[Novedades 1.1](novedades-1.1.html){: .btn .fs-5 .mb-4 .mb-md-0 }
...
- **Modo "Solo mi equipo"** y **multi-canal por plataforma** (sigue varios canales de Twitch a la vez). Ver [Novedades 1.1](novedades-1.1.html).
